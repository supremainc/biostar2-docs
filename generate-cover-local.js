...
/**
 * 로컬 커버 페이지 HTML 생성기
 * 명령줄 예시: node generate-cover-local.js --title="BioStar 2" --subtitle="IG" --version="1.08" --lang="한국어" --number="KO 101.00.853"
 */
...
function generateCoverHTML(params) {
    ...
    // 버전에 언어별 접두사 추가
    const processedVersion = `v${version}`;
    ...
    <style>
        ...
        * {
        ...
        .title {
            ...
            padding: 0.5315in 0.3937in 0.4633in 0.785in;
            color: #fff;
            display: flex;
...
예시:
  node generate-cover-local.js --title="BioStar 2" --subtitle="RN" --version="2.9.11" --lang="한국어" --number="301.00.BS2"
  node generate-cover-local.js --title="BioStar 2" --subtitle="RN" --version="2.9.11" --lang="English" --number="301.00.BS2"

옵션:
  --title     제품명 (기본값: "BioStar 2")
  ...
  --output    출력 파일 경로 (기본값: "./cover.html")
    ...
    console.log('\n📋 사용된 파라미터:');
    console.log(`  제품명: ${args.title || 'BioStar 2'}`);
