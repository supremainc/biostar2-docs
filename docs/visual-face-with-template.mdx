...
현재 FaceStation F2의 v1.x.x 펌웨어를 사용 중인 경우 BioStar 2 v2.9.7을 사용하기 위해서는 FaceStation F2를 최신 펌웨어로 업그레이드하여 사용하세요. (https://download.supremainc.com)
...
<Image src='/img/ko/biostar-297-data-file-export.png' className='none' caption />
