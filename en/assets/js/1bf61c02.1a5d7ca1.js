...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_298_deny_access_when_wearing_mask_mdx_1bf_namespaceObject = JSON.parse('{"id":"update/298/deny-access-when-wearing-mask","title":"마스크를 착용한 경우 인증을 거부하도록 설정하기","description":"마스크를 착용한 경우 인증을 거부하도록 설정하기","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/298/deny-access-when-wearing-mask.mdx","sourceDirName":"update/298","slug":"/update/298/deny-access-when-wearing-mask","permalink":"/biostar2-docs/en/update/298/deny-access-when-wearing-mask","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"deny-access-when-wearing-mask","title":"마스크를 착용한 경우 인증을 거부하도록 설정하기","description":"마스크를 착용한 경우 인증을 거부하도록 설정하기","keywords":["마스크 검출","마스크 착용 시 인증 거부"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"Version 2.9.8","permalink":"/biostar2-docs/en/update/biostar2-298"},"next":{"title":"사용자 정보에 파일 업로드하기","permalink":"/biostar2-docs/en/update/298/file-upload-user-information"}}')
