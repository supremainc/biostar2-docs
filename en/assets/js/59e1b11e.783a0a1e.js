"use strict";
(self['webpackChunkBioStar2_Docs'] = self['webpackChunkBioStar2_Docs'] || []).push([["899"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_advanced_search_mdx_59e_namespaceObject),
  assets: () => (/* binding */ assets),
  toc: () => (/* binding */ toc),
  contentTitle: () => (/* binding */ contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-advanced-search-mdx-59e.json
var site_docs_advanced_search_mdx_59e_namespaceObject = JSON.parse('{"id":"advanced-search","title":"고급 검색으로 사용자 검색하기","description":"기존 사용자 메뉴의 검색 기능은 이름과 이메일로만 사용자를 검색할 수 있었으나 새롭게 추가된 고급 검색 기능에서는 검색어의 범위를 줄이고 관련 없는 정보를 제외하여 원하는 정보를 정확하게 검색할 수 있습니다.","source":"@site/docs/advanced-search.mdx","sourceDirName":".","slug":"/advanced-search","permalink":"/biostar2-docs/en/advanced-search","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"advanced-search","title":"고급 검색으로 사용자 검색하기","description":"기존 사용자 메뉴의 검색 기능은 이름과 이메일로만 사용자를 검색할 수 있었으나 새롭게 추가된 고급 검색 기능에서는 검색어의 범위를 줄이고 관련 없는 정보를 제외하여 원하는 정보를 정확하게 검색할 수 있습니다.","keywords":["2.9.5","고급 검색"],"isTranslationMissing":true},"sidebar":"biostar","previous":{"title":"시간 제한 안티패스백 설정하기","permalink":"/biostar2-docs/en/timed-apb"},"next":{"title":"웹캠으로 프로필 사진 & 비주얼 페이스 등록하기","permalink":"/biostar2-docs/en/user-photo-enroll-using-webcam"}}')
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__("5893");
// EXTERNAL MODULE: ./node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__("65");
;// CONCATENATED MODULE: ./docs/advanced-search.mdx
