"use strict";
(self["webpackChunkBioStar2_Docs"] = self["webpackChunkBioStar2_Docs"] || []).push([["5707"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_i_18_n_en_docusaurus_plugin_content_docs_current_update_2910_settings_diretory_integration_mdx_ff2_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ settings_diretory_integration_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-i-18-n-en-docusaurus-plugin-content-docs-current-update-2910-settings-diretory-integration-mdx-ff2.json
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_2910_settings_diretory_integration_mdx_ff2_namespaceObject = JSON.parse('{"id":"update/2910/settings-diretory-integration","title":"Directory Integration Settings","description":"This document provides guidance on synchronizing and managing users by integrating Microsoft Entra ID or Active Directory with BioStar 2.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/2910/settings-diretory-integration.mdx","sourceDirName":"update/2910","slug":"/update/2910/settings-diretory-integration","permalink":"/help/biostar2-docs/en/update/2910/settings-diretory-integration","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"settings-diretory-integration","title":"Directory Integration Settings","description":"This document provides guidance on synchronizing and managing users by integrating Microsoft Entra ID or Active Directory with BioStar 2.","isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"Setting Facility Code Authentication for Offline Mode in Door Interface","permalink":"/help/biostar2-docs/en/update/2910/how-to-use-di24"},"next":{"title":"Updates in BioStar 2 v2.9.8","permalink":"/help/biostar2-docs/en/update/biostar2-298"}}')
...
;// CONCATENATED MODULE: ./i18n/en/docusaurus-plugin-content-docs/current/update/2910/settings-diretory-integration.mdx
