...
var site_docs_unified_gateway_mdx_40a_namespaceObject = JSON.parse('{"id":"unified-gateway","title":"BioStar 2 통합 게이트웨이 사용하기","description":"이 문서에서는 BioStar 2의 통합 게이트웨이에 대한 간단한 설명과 사용 방법을 설명합니다.","source":"@site/docs/unified-gateway.mdx","sourceDirName":".","slug":"/unified-gateway","permalink":"/biostar2-docs/en/unified-gateway","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"unified-gateway","title":"BioStar 2 통합 게이트웨이 사용하기","description":"이 문서에서는 BioStar 2의 통합 게이트웨이에 대한 간단한 설명과 사용 방법을 설명합니다.","keywords":["2.9.5","통합 게이트웨이"],"isTranslationMissing":true},"sidebar":"biostar","previous":{"title":"무선 도어락 사용하기","permalink":"/biostar2-docs/en/wireless-door-lock"}}')
