...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_298_update_timed_apb_mdx_4b3_namespaceObject = JSON.parse('{"id":"update/298/update-timed-apb","title":"Updated Timed Anti PassBack","description":"Updated Timed Anti PassBack","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/298/update-timed-apb.mdx","sourceDirName":"update/298","slug":"/update/298/update-timed-apb","permalink":"/help/biostar2-docs/en/update/298/update-timed-apb","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"update-timed-apb","title":"Updated Timed Anti PassBack","description":"Updated Timed Anti PassBack","keywords":["Timed Anti Passback","Reset Time","Bypass Group"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"Displaying User Private Messages on Devices","permalink":"/help/biostar2-docs/en/update/298/device-display-message"},"next":{"title":"CSN Mobile Card Deletion Management Guidelines","permalink":"/help/biostar2-docs/en/update/298/csn-mobile-card"}}')
