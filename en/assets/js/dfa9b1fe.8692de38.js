...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_295_timed_apb_mdx_dfa_namespaceObject = JSON.parse('{"id":"update/295/timed-apb","title":"How to Set Up the Timed Anti Passback","description":"Timed Anti PassBack restricts frequent entries by setting an initialization time for anti-passback. This feature prevents users from re-authenticating with the same device immediately after access authentication, ensuring a defined period must elapse before re-authentication is possible.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/295/timed-apb.mdx","sourceDirName":"update/295","slug":"/update/295/timed-apb","permalink":"/help/biostar2-docs/en/update/295/timed-apb","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"timed-apb","title":"How to Set Up the Timed Anti Passback","description":"Timed Anti PassBack restricts frequent entries by setting an initialization time for anti-passback. This feature prevents users from re-authenticating with the same device immediately after access authentication, ensuring a defined period must elapse before re-authentication is possible.","keywords":["Timed Anti PassBack"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"How to Use the Quick Action","permalink":"/help/biostar2-docs/en/update/295/quick-action"},"next":{"title":"How to Search for Users With Advanced Search","permalink":"/help/biostar2-docs/en/update/295/advanced-search"}}')
