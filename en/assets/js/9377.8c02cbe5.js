(self['webpackChunkBioStar2_Docs'] = self['webpackChunkBioStar2_Docs'] || []).push([["9377"], {
...
"4724": (function (__unused_webpack_module, __unused_webpack___webpack_exports__, __webpack_require__) {
"use strict";
...
var generated_constants = __webpack_require__("4849");
 ...
 */ function smartQueries(tokens, zhDictionary) {
    ...
    const distance = Math.max(0, generated_constants/* fuzzyMatchingDistance */.bJ);
...
class SearchWorker {
    ...
    async search(baseUrl, searchContext, input, limit) {
        const rawTokens = tokenize(input, generated_constants/* language */.dK);
...
async function legacyFetchIndexes(baseUrl, searchContext) {
    const url = `${baseUrl}${generated_constants/* searchIndexUrl,replace */.J.replace("{dir}", searchContext ? `-${searchContext.replace(/\//g, "-")}` : "")}`;
    ...
    const wrappedIndexes = json.map((param, type)=>{
        let { documents, index } = param;
        return {
            type: type,
            documents,
