...
6106: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_298_device_display_message_mdx_f8c_namespaceObject = JSON.parse('{"id":"update/298/device-display-message","title":"Displaying User Private Messages on Devices","description":"BioStar 2 v2.9.8, a private message option has been added to the server, allowing easier configuration of private messages directly from the server.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/298/device-display-message.mdx","sourceDirName":"update/298","slug":"/update/298/device-display-message","permalink":"/help/biostar2-docs/en/update/298/device-display-message","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"device-display-message","title":"Displaying User Private Messages on Devices","description":"BioStar 2 v2.9.8, a private message option has been added to the server, allowing easier configuration of private messages directly from the server.","keywords":["Device Display Message","Server Private Message"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"Uploading Files to User Information","permalink":"/help/biostar2-docs/en/update/298/file-upload-user-information"},"next":{"title":"Updated Timed Anti PassBack","permalink":"/help/biostar2-docs/en/update/298/update-timed-apb"}}')
