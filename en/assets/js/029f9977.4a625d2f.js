...
function _299_createMdxContent(props) {
  ...
  if (!Badge) _299_missingMdxReference("Badge", true);
  if (!BugLists) _299_missingMdxReference("BugLists", true);
  if (!Separator) _299_missingMdxReference("Separator", true);
...
function _299_missingMdxReference(id, component) {
  throw new Error("Expected " + (component ? "component" : "object") + " `" + id + "` to be defined: you likely forgot to import, pass, or provide it.");
}
