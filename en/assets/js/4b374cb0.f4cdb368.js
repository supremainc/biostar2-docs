...
"8147": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_298_update_timed_apb_mdx_4b3_namespaceObject = JSON.parse('{"id":"update/298/update-timed-apb","title":"시간 제한 안티패스백 업데이트","description":"시간 제한 안티패스백 업데이트","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/298/update-timed-apb.mdx","sourceDirName":"update/298","slug":"/update/298/update-timed-apb","permalink":"/biostar2-docs/en/update/298/update-timed-apb","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"update-timed-apb","title":"시간 제한 안티패스백 업데이트","description":"시간 제한 안티패스백 업데이트","keywords":["시간 제한 안티패스백","초기화 시간","항시 통과 그룹"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"장치에 사용자 개인 메시지 표시하기","permalink":"/biostar2-docs/en/update/298/device-display-message"},"next":{"title":"CSN 모바일 카드 삭제 시 관리 지침","permalink":"/biostar2-docs/en/update/298/csn-mobile-card"}}')
