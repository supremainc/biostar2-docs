...
var site_docs_revision_294_mdx_219_namespaceObject = JSON.parse('{"id":"revision/294","title":"버전 2.9.4 (v2.9.4.29)","description":"버전 2.9.4 (v2.9.4.29)","source":"@site/docs/revision/294.mdx","sourceDirName":"revision","slug":"/revision/294","permalink":"/biostar2-docs/en/revision/294","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"294","title":"버전 2.9.4 (v2.9.4.29)","description":"버전 2.9.4 (v2.9.4.29)","isTranslationMissing":true},"sidebar":"biostar","previous":{"title":"버전 2.9.5 (v2.9.5.29)","permalink":"/biostar2-docs/en/revision/295"},"next":{"title":"버전 2.9.3 (v2.9.3.26)","permalink":"/biostar2-docs/en/revision/293"}}')
...
const frontMatter = {
	...
	description: '버전 2.9.4 (v2.9.4.29)',
    ...
    children: [(0,jsx_runtime.jsx)(_components.h3, {
      ...
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            children: "모니터링"
          }), " 메뉴의 일부 목록에서 PDF 인쇄 시 서버가 멈추는 문제 (발생 버전: v2.9.3)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
          ...
          }), "을 발급한 후 저장하여도 이메일이 오지 않는 문제 (발생 버전: v2.8.11)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "출입 그룹"
          }), "의 상세 화면으로 진입하여 페이지 이동 버튼을 눌렀을 때 검색된 목록 내에서 이동되지 않고 전체 출입 그룹 목록에서 이동되는 문제 (발생 버전: v2.3.0)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["등록된 ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "그래픽 맵"
          }), "에서 갱신된 출입문 릴레이 상태를 불러오지 않는 문제 (발생 버전: v2.8.16)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "API를 이용하여 사용자 생성 시 다른 사용자가 사용 중인 카드를 할당하면 카드 중복되어 사용자 생성에 실패하는 문제 (발생 버전: v2.8.14)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "액티브 디렉토리"
          }), " 계정으로 로그인이 되지않는 문제 (발생 버전: v2.8.16)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            children: "CSV 불러오기"
          }), "를 이용하여 1000명 이상의 사용자를 생성하면 간헐적으로 실패하는 문제 (발생 버전: v2.9.3)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            children: "CSV 불러오기"
          }), "를 사용하여 잘못된 사용자 ID 생성이 가능한 문제 (발생 버전: v2.8.16)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["AoC(Access on Card)가 발급된 사용자에 ", (0,jsx_runtime.jsx)(_components.strong, {
            children: "CSV 불러오기"
          }), "로 사용자 정보를 덮어쓰기하여 변경한 경우 AoC 정보가 삭제되지만 블랙리스트에 추가되지 않는 문제 (발생 버전: v2.3.0)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "마스터-슬레이브-Wiegand 리더로 연결된 상태에서 특정 장치 그룹의 권한을 가진 사용자가 이벤트 로그 조회 시 Wiegand 리더의 동작 로그가 조회되지 않는 문제 (발생 버전: v2.6.3)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "일부 언어의 리소스 파일을 추가하고 언어 설정을 해당 언어로 변경해도 해당 언어로 표시되지 않는 문제 (발생 버전: v2.8.14)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "BioEntry W2 장치 추가 시 간헐적으로 로그아웃 되는 문제 (발생 버전: v2.9.0)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "MSSQL을 사용하는 환경에서 1000대 이상의 장치를 전체 삭제할 경우 삭제되지 않는 문제 (발생 버전: v2.9.3)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "MSSQL을 사용하는 환경에서 사용자 검색이 되지 않는 문제 (발생 버전: v2.8.0)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "이벤트 검색 API 호출 시 필수 파라미터를 채우지 않고 호출 했을 때 로그아웃되는 문제 (발생 버전: v2.0.0)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "CSN Mobile"
          }), " 카드로 인증이 실패하는 문제 (발생 버전: v2.9.0)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "AoC(Access on Card) 스마트 카드 쓰기 실패 시 블랙리스트로 추가되는 문제 (발생 버전: v2.4.1)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "암복호화 실행 시 서버가 정상적으로 종료되지 않는 문제 (발생 버전: v2.8.0)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "없음"
          }), "으로 설정하면 로그인 ID 정보가 삭제되는 문제 (발생 버전: v2.8.16)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "BioStar 2 로그인에 사용"
          }), "이 활성화된 상태에서 숫자로 시작되는 사용자 ID로 로그인하면 실패하는 문제 (발생 버전: v2.8.16)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          ...
          }), " 진행 시 비주얼 페이스가 업로드되지 않는 문제 (발생 버전: v2.8.10)"]
        }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "사용 안 함"
          }), "으로 설정한 후 모바일 카드가 등록된 사용자를 삭제할 경우 불필요한 오류 팝업이 표시되는 문제 (발생 버전: v2.9.0)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "*/api/users/data_export?id=*를 사용하여 API 호출 시 id에 입력된 사용자가 서버에 존재하지 않는 경우 서버가 종료되는 문제 (발생 버전: v2.8.10)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "API로 CSN 카드 발급 시 유효하지 않은 CARD_ID로 발급이 가능한 문제 (발생 버전: v2.0.0)"
        }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
          children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
            children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
        ...
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "DE-620과 카드의 기본 키를 사용하여 스마트 카드를 발급할 때 카드에 잘못된 키가 쓰여지는 문제 (발생 버전: v2.8.14)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
        ...
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: [(0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "사용자 그룹"
          }), "이 선택되어있는 사용자가 있을 경우 오류가 발생하는 문제(발생 버전: v2.9.3)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "BioStar 2를 D드라이브에 설치하면 리포트 서비스가 시작되지 않는 문제 (발생 버전: v2.9.3)"
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsxs)(_components.p, {
          children: ["모바일 카드로 인증 시 ", (0,jsx_runtime.jsx)(_components.strong, {
            ...
            children: "소집 구역"
          }), "의 인증 이벤트가 업데이트되지 않는 문제 (발생 버전: v2.8.6)"]
        }), "\n"]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["\n", (0,jsx_runtime.jsx)(_components.p, {
          children: "장치를 선택하여 장치 상세페이지로 진입 시 간헐적으로 서버가 종료되는 문제 (발생 버전: v2.0.0)"
        }), "\n"]
      }), "\n"]
    })]
  });
