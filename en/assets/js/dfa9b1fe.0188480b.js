...
"165": (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_295_timed_apb_mdx_dfa_namespaceObject = JSON.parse('{"id":"update/295/timed-apb","title":"시간 제한 안티패스백 설정하기","description":"시간 제한 안티패스백은 사용자가 출입 인증 후 동일한 장치에 다시 인증하고자 할 때 발생하는 안티패스백이 재인증을 할 수 있을 때까지 걸리는 초기화 시간을 설정하여 빈번한 입실을 제한할 수 있습니다.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/295/timed-apb.mdx","sourceDirName":"update/295","slug":"/update/295/timed-apb","permalink":"/biostar2-docs/en/update/295/timed-apb","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"timed-apb","title":"시간 제한 안티패스백 설정하기","description":"시간 제한 안티패스백은 사용자가 출입 인증 후 동일한 장치에 다시 인증하고자 할 때 발생하는 안티패스백이 재인증을 할 수 있을 때까지 걸리는 초기화 시간을 설정하여 빈번한 입실을 제한할 수 있습니다.","keywords":["시간 제한 안티패스백"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"How to Use the Quick Action","permalink":"/biostar2-docs/en/update/295/quick-action"},"next":{"title":"고급 검색으로 사용자 검색하기","permalink":"/biostar2-docs/en/update/295/advanced-search"}}')
