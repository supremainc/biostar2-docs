...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_295_quick_action_mdx_5c0_namespaceObject = JSON.parse('{"id":"update/295/quick-action","title":"How to Use the Quick Action","description":"A new addition to the TRIGGER & ACTION menu, Quick Action allows you to quickly control the operation of the door in an emergency situation.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/295/quick-action.mdx","sourceDirName":"update/295","slug":"/update/295/quick-action","permalink":"/help/biostar2-docs/en/update/295/quick-action","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"quick-action","title":"How to Use the Quick Action","description":"A new addition to the TRIGGER & ACTION menu, Quick Action allows you to quickly control the operation of the door in an emergency situation.","keywords":["Quick Action"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"How to Use the New Dashboard","permalink":"/help/biostar2-docs/en/update/295/new-dashboard"},"next":{"title":"How to Set Up the Timed Anti Passback","permalink":"/help/biostar2-docs/en/update/295/timed-apb"}}')
