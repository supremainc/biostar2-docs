...
7496: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_i_18_n_en_docusaurus_plugin_content_docs_current_update_295_wireless_door_lock_mdx_533_namespaceObject = JSON.parse('{"id":"update/295/wireless-door-lock","title":"How to Use a Wireless Door Lock","description":"Explains how to connect and set up a wireless door lock.","source":"@site/i18n/en/docusaurus-plugin-content-docs/current/update/295/wireless-door-lock.mdx","sourceDirName":"update/295","slug":"/update/295/wireless-door-lock","permalink":"/help/biostar2-docs/en/update/295/wireless-door-lock","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"wireless-door-lock","title":"How to Use a Wireless Door Lock","description":"Explains how to connect and set up a wireless door lock.","keywords":["Wireless Door Lock"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"How to Enroll Profile Photo & Visual Face Using a Webcam","permalink":"/help/biostar2-docs/en/update/295/user-photo-enroll-using-webcam"},"next":{"title":"How to Use the Unified Gateway","permalink":"/help/biostar2-docs/en/update/295/unified-gateway"}}')
