...
1. Upgraded MariaDB version (11.4.4).
    ...
    * MariaDB 11.4.4 is not supported on Windows Server 2012. BioStar 2 cannot be upgraded to version 2.9.10 on Windows Server 2012.
