...
1. To save the uploaded file, click <Cmd sid="button.apply" />. To delete it, click the <Image src='/img/ico-upload-delete.png' ico alone />.

    * After saving, the file can be downloaded by clicking the <Image src='/img/ico-download.png' ico alone /> or deleted by clicking the <Image src='/img/ico-delete.png' ico alone /> from the user information page.
