...
1. Select <Cmd sid='settings.activeDirectory.AdServerNew' /> in the <Cmd sid='settings.activeDirectory.title' /> section.
...
Enter the server information for **Entra ID** and click the <Cmd sid='settings.activeDirectory.Connect' /> button in the <Cmd sid='settings.activeDirectory.ADServerConfiguration' /> section.
...
The <Cmd sid='device.info.enabledrId' /> field cannot be mapped when integrating with **Entra ID**. It is automatically generated and applied by **BioStar 2**.
...
Change the <Cmd sid='settings.activeDirectory.LogintitleEI' /> item to <Cmd sid='device.info.enabled' /> to enable login to  **BioStar 2** using **Entra ID SSO**.
...
After completing all settings in <Cmd sid='setting.activeDirectory.menu' />, click the <Cmd sid='button.apply' /> button at the bottom of the screen to save. Refer to the [following](#checksettings) to check the results.
...
1. Select <Cmd sid='settings.activeDirectory.AdServerOld' /> in the <Cmd sid='settings.activeDirectory.title' /> section.
...
* To use the Active Directory server, set the <Cmd sid='setting.userDevice.useridType' /> to <Cmd sid='setting.userDevice.useridType.alphanumeric' /> in the <Cmd sid='common.setting' /> → <Cmd sid='setting.server' />, under the <Cmd sid='setting.server.userDeviceManagement' /> section.
...
Enter the server information for **Active Directory** and click the <Cmd sid='settings.activeDirectory.Connect' /> button in the <Cmd sid='settings.activeDirectory.ADServerConfiguration' /> section.
...
* <Cmd sid='settings.activeDirectory.secureTransfer' />: You can use encryption when communicating with the Windows Active Directory server. To install the Active Directory Certificate Services and configure the <Cmd sid='settings.activeDirectory.keystorePassword' />, refer to the [following](ad-encrypt).
  ...
  * <Cmd sid='settings.activeDirectory.keystorePassword' />: Enter the password for the encryption key store of the Windows Active Directory server. You can enter the password when the <Cmd sid='settings.activeDirectory.secureTransfer' /> item is set to <Cmd sid='device.info.enabled' />.
...
### <Cmd sid='settings.activeDirectory.LogintitleAD' /> (SSO 설정) {#setssoAD}

To configure login to **BioStar 2** using the user ID of the Active Directory server, change the <Cmd sid='settings.activeDirectory.LogintitleAD' /> item to <Cmd sid='device.info.enabled' />. The value of the `sAMAccountName` field from the Active Directory server will be mapped to the **BioStar 2** login ID.
...
After completing the integration settings with **Entra ID** or **Active Directory**, click the <Cmd sid='button.apply' /> button at the bottom of the screen. Refer to the following to check the synchronized settings.

* You can check the synchronized user list in the <Cmd sid='common.user' /> menu.

* After completing the login settings with **Entra ID** or **Active Directory**, you can see the <Cmd sid='login.entraidLoginBtn' /> button when logging in to **BioStar 2**.
...
1. When the detail information screen of the selected user appears, click the checkbox of the <Cmd sid='user.adsync.exclude' /> item in the <Cmd sid='common.advanced' /> section.

    <Image src='/img/biostar2-user-advance-exclude-sync.png' />

1. Click the <Cmd sid='button.apply' /> button.
...
1. Select <Cmd sid='settings.activeDirectory.notUse' /> in the <Cmd sid='settings.activeDirectory.title' /> section.

    <Image src='/img/biostar2-setting-directory-unset.png' />

1. When the <Cmd sid='modal.warningTitle' /> message appears, click the <Cmd sid='button.continue' /> button.

    <Image src='/img/biostar2-setting-directory-unset-warn-message.png' />

1. Click the <Cmd sid='button.apply' /> button at the bottom of the screen.
