...
1. <Image src='/img/en/ico-expert-setting.png' ico />을 클릭하여 <Cmd sid="settings.expertSettings.detail.title" />으로 진입한 다음 <Cmd sid="settings.expertSettings.detail.storeVisualFaceImageOptionLabel" />를 원하는 대로 설정하세요.
