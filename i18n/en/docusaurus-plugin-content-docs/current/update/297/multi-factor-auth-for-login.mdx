...
1. In the user list, <Image src='/img/common/ico-checkbox.png' ico alone /> check and select the users to configure, then click <Image src='/img/ico-batch-edit.png' ico />.

1. Click the <Image src='/img/common/ico-batch-edit-activate-button.png' ico alone /> for <Cmd sid="common.fingerprintLogin" /> to change to edit mode, then set it to <Cmd sid="user.fingerprintLogin.active" /> and click <Cmd sid="button.ok" />.
