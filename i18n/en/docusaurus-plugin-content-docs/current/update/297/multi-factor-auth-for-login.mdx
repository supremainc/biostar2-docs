...
1. In the user list, <Image src='/img/common/ico-checkbox.png' ico /> check and select the users to configure, then click <Image src='/img/en/ico-batch-edit.png' ico />.
...
1. The fingerprint input screen will appear. Place the enrolled finger on the fingerprint scanner to scan your fingerprint.
    ...
    * In the case of authentication failure, click the <Image src='/img/en/ico-retry.png' ico /> to attempt fingerprint authentication again. Up to two retry attempts are allowed.
