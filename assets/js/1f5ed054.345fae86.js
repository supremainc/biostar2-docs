...
2135: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_update_295_new_dashboard_mdx_1f5_namespaceObject = JSON.parse('{"id":"update/295/new-dashboard","title":"새 대시보드 사용하기","description":"새롭게 추가된 대시보드는 사용자 개인별로 원하는 정보를 선택하여 위젯을 추가하고, 자유롭게 위젯을 설정하고 배치하여 입맛에 맞게 구성할 수 있습니다.","source":"@site/docs/update/295/new-dashboard.mdx","sourceDirName":"update/295","slug":"/update/295/new-dashboard","permalink":"/help/biostar2-docs/update/295/new-dashboard","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"new-dashboard","title":"새 대시보드 사용하기","description":"새롭게 추가된 대시보드는 사용자 개인별로 원하는 정보를 선택하여 위젯을 추가하고, 자유롭게 위젯을 설정하고 배치하여 입맛에 맞게 구성할 수 있습니다.","keywords":["새 대시보드","위젯"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"2.9.5 버전 업데이트 안내","permalink":"/help/biostar2-docs/update/biostar2-295"},"next":{"title":"퀵 액션 사용하기","permalink":"/help/biostar2-docs/update/295/quick-action"}}')
