...
8997: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_update_298_file_upload_user_information_mdx_b86_namespaceObject = JSON.parse('{"id":"update/298/file-upload-user-information","title":"사용자 정보에 파일 업로드하기","description":"커스텀 사용자 필드를 사용하여 사용자 정보에 파일을 업로드하고 저장할 수 있습니다.","source":"@site/docs/update/298/file-upload-user-information.mdx","sourceDirName":"update/298","slug":"/update/298/file-upload-user-information","permalink":"/help/biostar2-docs/update/298/file-upload-user-information","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"file-upload-user-information","title":"사용자 정보에 파일 업로드하기","description":"커스텀 사용자 필드를 사용하여 사용자 정보에 파일을 업로드하고 저장할 수 있습니다.","keywords":["커스텀 사용자 필드","파일 업로드"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"마스크를 착용한 경우 인증을 거부하도록 설정하기","permalink":"/help/biostar2-docs/update/298/deny-access-when-wearing-mask"},"next":{"title":"장치에 사용자 개인 메시지 표시하기","permalink":"/help/biostar2-docs/update/298/device-display-message"}}')
