...
var site_docs_advanced_search_mdx_59e_namespaceObject = JSON.parse('{"id":"advanced-search","title":"고급 검색으로 사용자 검색하기","description":"기존 사용자 메뉴의 검색 기능은 이름과 이메일로만 사용자를 검색할 수 있었으나 새롭게 추가된 고급 검색 기능에서는 검색어의 범위를 줄이고 관련 없는 정보를 제외하여 원하는 정보를 정확하게 검색할 수 있습니다.","source":"@site/docs/advanced-search.mdx","sourceDirName":".","slug":"/advanced-search","permalink":"/biostar2-docs/advanced-search","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"advanced-search","title":"고급 검색으로 사용자 검색하기","description":"기존 사용자 메뉴의 검색 기능은 이름과 이메일로만 사용자를 검색할 수 있었으나 새롭게 추가된 고급 검색 기능에서는 검색어의 범위를 줄이고 관련 없는 정보를 제외하여 원하는 정보를 정확하게 검색할 수 있습니다.","keywords":["2.9.5","고급 검색"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"시간 제한 안티패스백 설정하기","permalink":"/biostar2-docs/timed-apb"},"next":{"title":"웹캠으로 프로필 사진 & 비주얼 페이스 등록하기","permalink":"/biostar2-docs/user-photo-enroll-using-webcam"}}')
