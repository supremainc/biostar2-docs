...
6934: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_update_297_multi_factor_auth_for_login_mdx_987_namespaceObject = JSON.parse('{"id":"update/297/multi-factor-auth-for-login","title":"다중 인증으로 BioStar 2 로그인하기","description":"BioStar 2에 로그인 시 ID와 비밀번호만으로는 계정의 보안이 부족하다고 느끼거나 보안을 강화하고 싶은 사용자의 경우 다중 인증 로그인 기능을 사용하여 계정의 보안을 향상 시킬 수 있습니다.","source":"@site/docs/update/297/multi-factor-auth-for-login.mdx","sourceDirName":"update/297","slug":"/update/297/multi-factor-auth-for-login","permalink":"/help/biostar2-docs/update/297/multi-factor-auth-for-login","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"multi-factor-auth-for-login","title":"다중 인증으로 BioStar 2 로그인하기","description":"BioStar 2에 로그인 시 ID와 비밀번호만으로는 계정의 보안이 부족하다고 느끼거나 보안을 강화하고 싶은 사용자의 경우 다중 인증 로그인 기능을 사용하여 계정의 보안을 향상 시킬 수 있습니다.","keywords":["다중 인증 로그인"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"2.9.7 버전 업데이트 안내","permalink":"/help/biostar2-docs/update/biostar2-297"},"next":{"title":"비주얼 페이스를 템플릿으로만 동기화하기","permalink":"/help/biostar2-docs/update/297/visual-face-with-template"}}')
