...
var site_docs_298_device_display_message_mdx_84d_namespaceObject = JSON.parse('{"id":"298-device-display-message","title":"장치에 사용자 개인 메시지 표시하기","description":"장치에 사용자 개인 메시지 표시하기","source":"@site/docs/298-device-display-message.mdx","sourceDirName":".","slug":"/298-device-display-message","permalink":"/biostar2-docs/298-device-display-message","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":298,"frontMatter":{"id":"298-device-display-message","title":"장치에 사용자 개인 메시지 표시하기","description":"장치에 사용자 개인 메시지 표시하기","keywords":["장치 표시 메시지","서버 개인 메시지"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"사용자 정보에 파일 업로드하기","permalink":"/biostar2-docs/298-file-upload-user-information"},"next":{"title":"시간 제한 안티패스백 업데이트","permalink":"/biostar2-docs/298-update-timed-apb"}}')
