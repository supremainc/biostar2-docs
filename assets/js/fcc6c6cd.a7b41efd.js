...
var site_docs_298_file_upload_user_information_mdx_fcc_namespaceObject = JSON.parse('{"id":"298-file-upload-user-information","title":"사용자 정보에 파일 업로드하기","description":"사용자 정보에 파일 업로드하기","source":"@site/docs/298-file-upload-user-information.mdx","sourceDirName":".","slug":"/298-file-upload-user-information","permalink":"/biostar2-docs/298-file-upload-user-information","draft":false,"unlisted":false,"tags":[],"version":"current","sidebarPosition":298,"frontMatter":{"id":"298-file-upload-user-information","title":"사용자 정보에 파일 업로드하기","description":"사용자 정보에 파일 업로드하기","keywords":["커스텀 사용자 필드","파일 업로드"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"마스크를 착용한 경우 인증을 거부하도록 설정하기","permalink":"/biostar2-docs/298-deny-access-when-wearing-mask"},"next":{"title":"장치에 사용자 개인 메시지 표시하기","permalink":"/biostar2-docs/298-device-display-message"}}')
