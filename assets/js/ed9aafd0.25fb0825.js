...
2429: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_update_295_wireless_door_lock_mdx_ed9_namespaceObject = JSON.parse('{"id":"update/295/wireless-door-lock","title":"무선 도어락 사용하기","description":"무선 도어락의 연결 방법부터 설정 방법까지 설명합니다.","source":"@site/docs/update/295/wireless-door-lock.mdx","sourceDirName":"update/295","slug":"/update/295/wireless-door-lock","permalink":"/help/biostar2-docs/update/295/wireless-door-lock","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"wireless-door-lock","title":"무선 도어락 사용하기","description":"무선 도어락의 연결 방법부터 설정 방법까지 설명합니다.","keywords":["무선 도어락"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"웹캠으로 프로필 사진 & 비주얼 페이스 등록하기","permalink":"/help/biostar2-docs/update/295/user-photo-enroll-using-webcam"},"next":{"title":"BioStar 2 통합 게이트웨이 사용하기","permalink":"/help/biostar2-docs/update/295/unified-gateway"}}')
