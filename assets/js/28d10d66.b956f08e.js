...
var site_docs_wireless_door_lock_mdx_28d_namespaceObject = JSON.parse('{"id":"wireless-door-lock","title":"무선 도어락 사용하기","description":"무선 도어락의 연결 방법부터 설정 방법까지 설명합니다.","source":"@site/docs/wireless-door-lock.mdx","sourceDirName":".","slug":"/wireless-door-lock","permalink":"/biostar2-docs/wireless-door-lock","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"wireless-door-lock","title":"무선 도어락 사용하기","description":"무선 도어락의 연결 방법부터 설정 방법까지 설명합니다.","keywords":["2.9.5","다중 인증"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"웹캠으로 프로필 사진 & 비주얼 페이스 등록하기","permalink":"/biostar2-docs/user-photo-enroll-using-webcam"},"next":{"title":"BioStar 2 통합 게이트웨이 사용하기","permalink":"/biostar2-docs/unified-gateway"}}')
