...
var site_docs_timed_apb_mdx_73b_namespaceObject = JSON.parse('{"id":"timed-apb","title":"시간 제한 안티패스백 설정하기","description":"시간 제한 안티패스백은 사용자가 출입 인증 후 동일한 장치에 다시 인증하고자 할 때 발생하는 안티패스백이 재인증을 할 수 있을 때까지 걸리는 초기화 시간을 설정하여 빈번한 입실을 제한할 수 있습니다.","source":"@site/docs/timed-apb.mdx","sourceDirName":".","slug":"/timed-apb","permalink":"/biostar2-docs/timed-apb","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"timed-apb","title":"시간 제한 안티패스백 설정하기","description":"시간 제한 안티패스백은 사용자가 출입 인증 후 동일한 장치에 다시 인증하고자 할 때 발생하는 안티패스백이 재인증을 할 수 있을 때까지 걸리는 초기화 시간을 설정하여 빈번한 입실을 제한할 수 있습니다.","keywords":["2.9.5","시간 제한 안티패스백백"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"퀵 액션 사용하기","permalink":"/biostar2-docs/quick-action"},"next":{"title":"고급 검색으로 사용자 검색하기","permalink":"/biostar2-docs/advanced-search"}}')
