"use strict";
(self["webpackChunkBioStar2_Docs"] = self["webpackChunkBioStar2_Docs"] || []).push([["5556"], {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_update_2910_settings_diretory_integration_mdx_fd4_namespaceObject),
  assets: () => (/* binding */ assets),
  contentTitle: () => (/* binding */ settings_diretory_integration_contentTitle)
});

;// CONCATENATED MODULE: ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-update-2910-settings-diretory-integration-mdx-fd4.json
var site_docs_update_2910_settings_diretory_integration_mdx_fd4_namespaceObject = JSON.parse('{"id":"update/2910/settings-diretory-integration","title":"디렉토리 연동 설정하기","description":"Microsoft Entra ID와 BioStar 2를 연동하여 사용자를 동기화하고 관리하는 방법을 안내합니다.","source":"@site/docs/update/2910/settings-diretory-integration.mdx","sourceDirName":"update/2910","slug":"/update/2910/settings-diretory-integration","permalink":"/help/biostar2-docs/update/2910/settings-diretory-integration","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"settings-diretory-integration","title":"디렉토리 연동 설정하기","description":"Microsoft Entra ID와 BioStar 2를 연동하여 사용자를 동기화하고 관리하는 방법을 안내합니다.","isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"Door Interface 오프라인 모드 전용 시설 코드 인증 설정하기","permalink":"/help/biostar2-docs/update/2910/how-to-use-di24"},"next":{"title":"2.9.8 버전 업데이트 안내","permalink":"/help/biostar2-docs/update/biostar2-298"}}')
...
;// CONCATENATED MODULE: ./docs/update/2910/settings-diretory-integration.mdx
