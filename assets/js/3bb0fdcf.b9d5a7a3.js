...
var site_docs_new_dashboard_mdx_3bb_namespaceObject = JSON.parse('{"id":"new-dashboard","title":"새 대시보드 사용하기","description":"새롭게 추가된 대시보드는 사용자 개인별로 원하는 정보를 선택하여 위젯을 추가하고, 자유롭게 위젯을 설정하고 배치하여 입맛에 맞게 구성할 수 있습니다.","source":"@site/docs/new-dashboard.mdx","sourceDirName":".","slug":"/new-dashboard","permalink":"/biostar2-docs/new-dashboard","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"new-dashboard","title":"새 대시보드 사용하기","description":"새롭게 추가된 대시보드는 사용자 개인별로 원하는 정보를 선택하여 위젯을 추가하고, 자유롭게 위젯을 설정하고 배치하여 입맛에 맞게 구성할 수 있습니다.","keywords":["2.9.5","다중 인증"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"비주얼 페이스를 템플릿으로만 동기화하기","permalink":"/biostar2-docs/visual-face-with-template"},"next":{"title":"퀵 액션 사용하기","permalink":"/biostar2-docs/quick-action"}}')
