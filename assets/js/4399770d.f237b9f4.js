...
4044: (function (__unused_webpack_module, __webpack_exports__, __webpack_require__) {
// ESM COMPAT FLAG
...
var site_docs_update_295_timed_apb_mdx_439_namespaceObject = JSON.parse('{"id":"update/295/timed-apb","title":"시간 제한 안티패스백 설정하기","description":"시간 제한 안티패스백은 사용자가 출입 인증 후 동일한 장치에 다시 인증하고자 할 때 발생하는 안티패스백이 재인증을 할 수 있을 때까지 걸리는 초기화 시간을 설정하여 빈번한 입실을 제한할 수 있습니다.","source":"@site/docs/update/295/timed-apb.mdx","sourceDirName":"update/295","slug":"/update/295/timed-apb","permalink":"/help/biostar2-docs/update/295/timed-apb","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"timed-apb","title":"시간 제한 안티패스백 설정하기","description":"시간 제한 안티패스백은 사용자가 출입 인증 후 동일한 장치에 다시 인증하고자 할 때 발생하는 안티패스백이 재인증을 할 수 있을 때까지 걸리는 초기화 시간을 설정하여 빈번한 입실을 제한할 수 있습니다.","keywords":["시간 제한 안티패스백"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"퀵 액션 사용하기","permalink":"/help/biostar2-docs/update/295/quick-action"},"next":{"title":"고급 검색으로 사용자 검색하기","permalink":"/help/biostar2-docs/update/295/advanced-search"}}')
