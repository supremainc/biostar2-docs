...
var site_docs_update_298_deny_access_when_wearing_mask_mdx_5a3_namespaceObject = JSON.parse('{"id":"update/298/deny-access-when-wearing-mask","title":"마스크를 착용한 경우 인증을 거부하도록 설정하기","description":"사용자가 마스크를 착용하고 있는 경우 얼굴 인증을 거부하도록 설정하여 얼굴 인증의 정확도를 높일 수 있습니다.","source":"@site/docs/update/298/deny-access-when-wearing-mask.mdx","sourceDirName":"update/298","slug":"/update/298/deny-access-when-wearing-mask","permalink":"/biostar2-docs/update/298/deny-access-when-wearing-mask","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"deny-access-when-wearing-mask","title":"마스크를 착용한 경우 인증을 거부하도록 설정하기","description":"사용자가 마스크를 착용하고 있는 경우 얼굴 인증을 거부하도록 설정하여 얼굴 인증의 정확도를 높일 수 있습니다.","keywords":["마스크 검출","마스크 착용 시 인증 거부"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"2.9.8 버전 업데이트 안내","permalink":"/biostar2-docs/update/biostar2-298"},"next":{"title":"사용자 정보에 파일 업로드하기","permalink":"/biostar2-docs/update/298/file-upload-user-information"}}')
