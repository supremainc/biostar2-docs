...
var site_docs_update_295_advanced_search_mdx_8b9_namespaceObject = JSON.parse('{"id":"update/295/advanced-search","title":"고급 검색으로 사용자 검색하기","description":"기존 사용자 메뉴의 검색 기능은 이름과 이메일로만 사용자를 검색할 수 있었으나 새롭게 추가된 고급 검색 기능에서는 검색어의 범위를 줄이고 관련 없는 정보를 제외하여 원하는 정보를 정확하게 검색할 수 있습니다.","source":"@site/docs/update/295/advanced-search.mdx","sourceDirName":"update/295","slug":"/update/295/advanced-search","permalink":"/help/biostar2-docs/update/295/advanced-search","draft":false,"unlisted":false,"tags":[],"version":"current","frontMatter":{"id":"advanced-search","title":"고급 검색으로 사용자 검색하기","description":"기존 사용자 메뉴의 검색 기능은 이름과 이메일로만 사용자를 검색할 수 있었으나 새롭게 추가된 고급 검색 기능에서는 검색어의 범위를 줄이고 관련 없는 정보를 제외하여 원하는 정보를 정확하게 검색할 수 있습니다.","keywords":["고급 검색"],"isTranslationMissing":false},"sidebar":"biostar","previous":{"title":"시간 제한 안티패스백 설정하기","permalink":"/help/biostar2-docs/update/295/timed-apb"},"next":{"title":"웹캠으로 프로필 사진 & 비주얼 페이스 등록하기","permalink":"/help/biostar2-docs/update/295/user-photo-enroll-using-webcam"}}')
